...
public class Principal {
	...
	public static void main(String[] args) {
		...
		JLabel rtlFaltas = new JLabel();
		rtlFaltas.setText("Numero de faltas");
		rtlFaltas.setBounds(10, 90, 110, 20);
		...
		campo5.setBounds(130, 90, 150, 20);

		//JButton
		JButton botao = new JButton();
		botao.setText("ok");
		botao.setBounds(130, 110, 150, 20);
		...
		botao.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(Double.parseDouble(campo5.getText()) > 15){
