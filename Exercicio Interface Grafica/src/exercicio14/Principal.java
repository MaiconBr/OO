...
public class Principal {
	...
	public static void main(String[] args) {
		...
		rtlNome.setText("Informe o valor");
		...
		botao.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				double valorveiculo, valordistribuidor, valorimposto;
				
				valorveiculo = Double.parseDouble(campo.getText());

				if(valorveiculo <= 12000){
					valordistribuidor = valorveiculo*0.05;
					valorveiculo = valorveiculo - valordistribuidor;
					...
					valorveiculo = (valorveiculo - valordistribuidor)-valorimposto;
